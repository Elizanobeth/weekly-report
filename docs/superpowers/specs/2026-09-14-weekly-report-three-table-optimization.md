...
周报记录表通过“关联事项”引用事项台账。成员不重复填写基础资料；系统在提交时复制项目名称、任务名称、事项类型、责任人和计划完成时间，用于还原历史周会内容。
...
| 当周项目名称 | 单行文本 | 系统复制 | 提交时从事项台账复制，之后不随台账变化 |
| 当周任务名称 | 单行文本 | 系统复制 | 提交时从事项台账复制，之后不随台账变化 |
| 当周事项类型 | 单选/文本 | 系统复制 | KPI项目、非KPI需求、临时任务 |
| 责任人 | 成员/文本 | 系统复制 | 从关联事项带出并保存，用于成员分组 |
| 当周计划完成时间 | 日期 | 系统复制 | 提交时保存当周计划完成日期 |
